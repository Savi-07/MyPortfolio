  ...
  return (
    <section className="contact-section" id="contact">
      ...
      <div className="contact-form-wrapper">
        ...
        <br />
        <form className="contact-form" action="https://formspree.io/f/mrbkdodn" method="POST">
          <input type="email" name="email" placeholder="Your email" required className="contact-input" />
          <button type="submit" className="contact-send-btn"><FaPaperPlane /></button>
        </form>
      </div>
      {/* <footer className="contact-footer">
        <span className="footer-left">copyright @ 2025</span>
        <span className="footer-right">DESIGNED, DEVELOPED AND MAINTAINED BY SAHIL KUMAR SINGH</span>
      </footer> */}
    </section>
  );
};
